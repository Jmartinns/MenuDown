        ...
        VStack(spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                tipRow(
                    ...
                    description: "Press this shortcut anytime to toggle the MenuDown panel — no need to find the icon."
                )

                tipRow(
                    icon: "arrow.left.arrow.right",
                    title: "Reposition the icon",
                    description: "Hold \u{2318} Command and drag the MenuDown icon (arrow-down circle) in your menubar to move it away from the notch."
                )
